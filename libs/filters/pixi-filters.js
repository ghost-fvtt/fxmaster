...
var __filters = (function (e, t, n, r, o, i, l, s) {
  ...
  var a =
    ...
    C = (function (e) {
      function t(t) {
        void 0 === t && (t = 8), e.call(this, b, _), (this.size = t);
      }
      e && (t.__proto__ = e), (t.prototype = Object.create(e && e.prototype)), (t.prototype.constructor = t);
    ...
    Q = (function (e) {
      function t(t, n) {
        void 0 === t && (t = 1), void 0 === n && (n = 5), e.call(this, Y, G), (this.scale = t), (this.angle = n);
      }
      e && (t.__proto__ = e), (t.prototype = Object.create(e && e.prototype)), (t.prototype.constructor = t);
    ...
    J = (function (e) {
      function t(t) {
        void 0 === t && (t = 5), e.call(this, H, $), (this.strength = t);
      }
      e && (t.__proto__ = e), (t.prototype = Object.create(e && e.prototype)), (t.prototype.constructor = t);
  ...
  (ne.TRANSPARENT = 0), (ne.ORIGINAL = 1), (ne.LOOP = 2), (ne.CLAMP = 3), (ne.MIRROR = 4);
  var re = a,
    oe =
      ...
      function t(t, n, r, o, i) {
        void 0 === t && (t = 10),
          ...
          e.call(
            this,
            re,
            oe.replace(/%QUALITY_DIST%/gi, "" + (1 / i / t).toFixed(7)).replace(/%DIST%/gi, "" + t.toFixed(7)),
          ),
      ...
      return (
        ...
        (r.velocity.set = function (e) {
          Array.isArray(e)
            ...
            : (e instanceof n.Point || e instanceof n.ObservablePoint) && this._velocity.copy(e);
        }),
  ...
  (_e.MIN_SAMPLES = 1), (_e.MAX_SAMPLES = 100);
  var Ce = a,
    Se =
      "precision mediump float;\n\nvarying vec2 vTextureCoord;\n\nuniform vec2 size;\nuniform sampler2D uSampler;\n\nuniform vec4 filterArea;\n\nvec2 mapCoord( vec2 coord )\n{\n    coord *= filterArea.xy;\n    coord += filterArea.zw;\n\n    return coord;\n}\n\nvec2 unmapCoord( vec2 coord )\n{\n    coord -= filterArea.zw;\n    coord /= filterArea.xy;\n\n    return coord;\n}\n\nvec2 pixelate(vec2 coord, vec2 size)\n{\n\treturn floor( coord / size ) * size;\n}\n\nvoid main(void)\n{\n    vec2 coord = mapCoord(vTextureCoord);\n\n    coord = pixelate(coord, size);\n\n    coord = unmapCoord(coord);\n\n    gl_FragColor = texture2D(uSampler, coord);\n}\n",
    Fe = (function (e) {
      function t(t) {
        void 0 === t && (t = 10), e.call(this, Ce, Se), (this.size = t);
      }
      e && (t.__proto__ = e), (t.prototype = Object.create(e && e.prototype)), (t.prototype.constructor = t);
      var n = { size: { configurable: !0 } };
      return (
